...
["Display durability in the item icon for certain items."] = "Muestra la durabilidad en el icono del objeto para ciertos objetos.",
["Show Quality Color"] = "Mostrar Color de Calidad",
["Display quality colors in the item icon for certain items."] = "Muestra el color que representa la calidad del objeto para ciertos objetos.",
